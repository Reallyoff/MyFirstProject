 ...
 1. Цель работы
 Научиться основам работы с Git: инициализация репозитория, создание коммитов, работа с ветками, разрешение конфликтов и публикация проекта на GitHub.
 ...
 git commit -m "message"	         оздание коммита
